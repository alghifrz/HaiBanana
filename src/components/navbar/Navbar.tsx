...
export function Navbar() {
  ...
  return (
    <>
      <header
        className={`fixed inset-x-0 top-0 z-50 pt-[env(safe-area-inset-top)] transition-[background-color,box-shadow] duration-300 ease-out ${
          isMenuOpen
            ? "bg-cream"
            : isScrolled
              ? "bg-cream/80 shadow-sm shadow-ink/5 backdrop-blur-[2px]"
              : "bg-cream/80 backdrop-blur-[2px] lg:bg-transparent"
        }`}
      >
        <Container>
